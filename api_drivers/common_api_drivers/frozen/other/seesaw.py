...
class SEESAW:
    ...
    def __init__(self, i2c_bus, addr=0x49, drdy=None, reset=True):
        ...
        self._tx_buf = bytearray(32)
        self._tx_mv = memoryview(self._tx_buf)
        self._rx_buf = bytearray(32)
        self._rx_mv = memoryview(self._rx_buf)
        
        self.i2c_device = I2C.Device(i2c_bus, addr)
    ...
    def write(self, reg_base, reg, buf=None):
        ...
        self.i2c_device.write(full_buffer)
        

    def read(self, reg_base, reg, buf, delay=0.01):
