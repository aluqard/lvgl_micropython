...
rm -rf lib/micropython/ports/esp32/build-ESP32_CYD

python3 make.py esp32 clean BOARD=ESP32_CYD DISPLAY=ili9341 INDEV=xpt2046 --dual-core-threads --enable-uart-repl=y
