...
python3 make.py esp32 clean BOARD=T_DISPLAYS3 BOARD_VARIANT=SPIRAM_OCT DISPLAY=st7789 FROZEN_MANIFEST=$(pwd)/lib/micropython/ports/esp32/boards/T_DISPLAYS3/manifest.py --dual-core-threads --enable-cdc-repl=y
